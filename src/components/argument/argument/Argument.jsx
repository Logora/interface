                ...
                { argument.number_replies > 0 && !hideReplies &&
                    <div className={cx(styles.replyFooter, {[styles.commentReplyFooter]: isComment})} onClick={toggleReplies}>
                        ...
                        <div className={styles.expandRepliesContainer}>
                            <button tabIndex='0' className={cx(styles.expandRepliesButton, {[styles.repliesExpanded]: expandReplies})}>
                                <FormattedMessage
                ...
                { startReplyInput && (
                    <Suspense fallback={null}>
                        <ArgumentInput
                            ...
                            onSubmit={(reply) => onReplySubmit(reply)}
                            isReply
                            avatarSize={40}
                ...
                { expandReplies &&
                    <div className={styles.repliesList}>
                        <VotePaginatedList
                            ...
                            onLoad={(newReplies) => setReplies(prevReplies => [...prevReplies, ...newReplies])}
                        >
                            <ArgumentContainer
