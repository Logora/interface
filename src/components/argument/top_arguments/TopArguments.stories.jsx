				...
				<ResponsiveProvider>
					<IntlProvider locale="en">
						<TopArguments
							...
							argumentAgainst={
								showArgumentAgainst ? argumentAgainst : undefined
							}
						/>
					</IntlProvider>
				</ResponsiveProvider>
...
export const TopArgumentsWithEmptyArgument = (props) =>
	renderStory({
...
export const TopArgumentsNewDesign = (props) =>
	renderStory({
		newDesign: true,
		showArgumentFor: false,
		argumentCount: [0, 3],
...
export const TopArgumentsNewDesignWithEmptyArgument = (props) =>
	renderStory({
		newDesign: true,
		showArgumentFor: false,
