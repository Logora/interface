		...
		return (
			<div className={styles.formFooterTerms}>
				<FormattedMessage
					...
					defaultMessage={
						'By clicking on "Subscribe", you confirm that you accept the <var1>General Conditions of Use</var1> and our <var2>Privacy Policy</var2> which informs you of the methods of processing your personal data as well as your rights over this data.'
					}
				/>
			</div>
		);
				...
				<div className={styles.formFooter}>
					<div className={styles.formFooterRow}>
						<div>
							{intl.formatMessage({
								id: loginStep
									? "auth.social_auth_form.no_account"
									: "auth.social_auth_form.already_account",
								defaultMessage: loginStep
									? "No account yet ?"
						...
						<div
							...
							onClick={() => setLoginStep(!loginStep)}
						>
							{intl.formatMessage({
								id: loginStep
									? "auth.social_auth_form.signup"
									: "auth.social_auth_form.login",
								defaultMessage: loginStep ? "Sign up" : "Sign in",
							})}
						</div>
					</div>
				</div>
			...
			{mainMenu ? (
				<>
					...
					<div className={styles.socialLoginText}>
						{intl.formatMessage({
							id: "auth.social_auth_form.menu_title",
							defaultMessage:
								"Create your account in one click to vote and start debating !",
						})}
					</div>
					<FacebookLoginButton
						...
						<div className={styles.checkboxContainer}>
							<Toggle
								...
								label={intl.formatMessage(
									{
										id: "auth.social_auth_form.accepts_emails_label",
					...
					{error && lastStep === "SOCIAL" ? (
						<div className={styles.errorGroup}>
							{intl.formatMessage({
								id: "auth.social_auth_form.error",
								defaultMessage:
				...
				<>
					<div className={styles.formTitleContainer}>
						<div
							className={styles.formBackArrow}
						...
						>
							...
							&nbsp;
							{intl.formatMessage({
								id: "auth.social_auth_form.back_to_menu",
						...
						<div className={styles.formTitle}>
							{intl.formatMessage({
								id: loginStep
									? "auth.social_auth_form.login_title"
									: "auth.social_auth_form.signup_title",
								defaultMessage: loginStep
									? "Sign in to enter the debate space"
					...
					{!loginStep ? (
						<>
							<div className={styles.signUpSubtitle}>
								{intl.formatMessage(
									{
										id: "auth.social_auth_form.signup_subtitle",
										defaultMessage: "Sign up in a few clicks to start debating",
									},
