...
export const SocialAuthFormWithoutLogo = (props) =>
	renderStory({
		logoUrl: null,
		...props,
	});

export const SocialAuthFormLoginForm = (props) =>
	renderStory({ lastStep: "LOGIN", ...props });

export const SocialAuthFormSignupForm = (props) =>
	renderStory({ lastStep: "SIGNUP", ...props });
