...
export const SSOFormWithRedirect = (props) =>
	renderStory({
		authType: "other",
...
export const SSOFormWithEmailConsent = (props) =>
	renderStory({
		showEmailConsent: true,
		providerName: "FSociety Inc.",
		...props,
...
export const SSOFormWithTerms = (props) =>
	renderStory({
		showEmailConsent: true,
		showTerms: true,
		providerName: "FSociety Inc.",
...
export const SSOFormWithError = (props) =>
	renderStory({
		showEmailConsent: true,
		providerName: "FSociety Inc.",
		error: true,
...
export const SSOFormWithoutActions = (props) =>
	renderStory({
...
export const SSOFormHideBelowButton = (props) =>
	renderStory({
		subtitle: "My awesome subtitle to give more info",
		showEmailConsent: true,
		providerName: "FSociety Inc.",
