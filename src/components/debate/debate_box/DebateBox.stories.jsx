        ...
        <BrowserRouter>
            <IntlProvider locale="en">
                <IconProvider library={regularIcons}>
                    <ResponsiveProvider>
                        <ConfigProvider routes={{ ...routes }} config={{ modules: {}, actions: { allowDebateBranding } }}>
...
export const BrandedDebateBox = (props) => renderStory({ allowDebateBranding: true, ...props });

export const DebateBoxWithLongAnswers = (props) => renderStory({ debate: debateWithLongPositionNames, ...props });
