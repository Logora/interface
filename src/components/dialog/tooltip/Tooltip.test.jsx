...
describe("Tooltip", () => {
	it("should render with the correct text", async () => {
		const tooltip = render(
			<Tooltip text={"hover tooltip"} onClickText={"click"}>
				Child
			</Tooltip>,
		);
	...
	it("should be at the props position", () => {
		render(
			<Tooltip text={"hover tooltip"} onClickText={"click"} position={"top"}>
				Child
			</Tooltip>,
		);
		const renderedTooltip = document.querySelector(
	...
	it("should render with info variant", () => {
		const { getByText } = render(
			<Tooltip text="Info tooltip" className="info">
				Child
			</Tooltip>,
		);
