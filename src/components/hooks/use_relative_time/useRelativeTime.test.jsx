...
const messages = {
	"relative_time.past.second":
		"{time, plural, one {# second} other {# seconds}} ago",
	"relative_time.past.minute":
		"{time, plural, one {# minute} other {# minutes}} ago",
	"relative_time.past.hour": "{time, plural, one {# hour} other {# hours}} ago",
	"relative_time.past.day": "{time, plural, one {# day} other {# days}} ago",
	"relative_time.past.month":
		"{time, plural, one {# month} other {# months}} ago",
	"relative_time.past.year": "{time, plural, one {# year} other {# years}} ago",
	"relative_time.future.second":
		"{time, plural, one {# second} other {# seconds}} left",
	"relative_time.future.minute":
		"{time, plural, one {# minute} other {# minutes}} left",
	"relative_time.future.hour":
		"{time, plural, one {# hour} other {# hours}} left",
	"relative_time.future.day": "{time, plural, one {# day} other {# days}} left",
	"relative_time.future.month":
		"{time, plural, one {# month} other {# months}} left",
	"relative_time.future.year":
		"{time, plural, one {# year} other {# years}} left",
};
