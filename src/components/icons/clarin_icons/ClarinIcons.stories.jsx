...
export const ClarinIconsLibrary = () => {
	return (
		<div
		...
		>
			...
			<OpenBlank
				width={50}
				height={50}
				data-testid={"open-blank-icon"}
				style={{ margin: "15px" }}
			/>
			<OrderedList
				width={50}
				height={50}
				data-testid={"ordered-list-icon"}
				style={{ margin: "15px" }}
			/>
			<PauseCircle
				width={50}
				height={50}
				data-testid={"pausecircle-icon"}
				style={{ margin: "15px" }}
			/>
			<Point
				width={50}
