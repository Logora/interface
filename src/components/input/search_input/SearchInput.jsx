...
export const SearchInput = ({
	...
	useOnClickOutside(
		searchRef,
		reducedByDefault ? () => setOpenSearch(false) : null,
	);
	...
	return !reducedByDefault || openSearch ? (
		<form
			...
			<TextInput
				...
				iconRight={
					query && (
						<Icon
							...
							aria-label={intl.formatMessage({
								id: "input.search_input.reset_icon.aria_label",
				...
				iconLeft={
					<Icon
						...
						aria-label={intl.formatMessage({
							id: "input.search_input.submit_icon.aria_label",
							defaultMessage: "starts search",
						})}
					/>
				}
			/>
		...
		<div
			className={styles.searchReducedButton}
