			...
			(
				<form data-tid={"form_search"} onSubmit={handleSubmit} method='get' autoComplete='off' ref={searchRef}>
					<TextInput
						...
						iconRight=
						{query &&
							<Icon name="close" className={styles.searchReset} role="reset" data-tid={"action_search_reset"} height={16} width={16} onClick={(e) => handleReset(e)} ria-label={intl.formatMessage({id: "input.search_input.reset_icon.aria_label", defaultMessage: "Reset search"})} />
						}
