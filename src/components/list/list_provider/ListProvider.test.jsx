...
describe("ListProvider", () => {
	...
	it("should set correct addElements", async () => {
		...
		const AddElementComponent = () => {
			...
			return <button onClick={handleClick}>Add elements</button>;
		};

		const List = () => {
			const { addElements } = useList();

			return <div>{addElements["myList"]}</div>;
		};
	...
	it("should set correct removeElement", async () => {
		...
		const List = () => {
			...
			return <div>{removeElements["myRemoveList"]}</div>;
		};
	...
	it("should set correct updateElement", async () => {
		...
		const List = () => {
			...
			return <div>{updateElements["myUpdateList"]}</div>;
		};
