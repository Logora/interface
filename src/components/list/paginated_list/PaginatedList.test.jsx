...
describe("PaginatedList", () => {
  ...
  it("should call api correctly after pagination and sort click", async () => {
    ...
    expect(mock).toHaveBeenLastCalledWith(
      "https://mock.example.api/items?page=2&per_page=1&sort=-created_at&api_key="
    );
    ...
    expect(mock).toHaveBeenLastCalledWith(
      "https://mock.example.api/items?page=1&per_page=1&sort=-oldest&api_key="
    );
  ...
  it("should call api with query params if passed as props", async () => {
    ...
    expect(mock).toHaveBeenNthCalledWith(
      1,
      "https://mock.example.api/items?page=1&per_page=1&query=test&api_key="
    );
  });
  ...
  it("should call api with countless prop if passed", async () => {
    ...
    expect(mock).toHaveBeenNthCalledWith(
      1,
      "https://mock.example.api/items?page=1&per_page=1&sort=-created_at&countless=true&api_key="
    );
  });
  ...
  it("should call api with first sortOption from props (getInitSort func)", async () => {
    ...
    expect(mock).toHaveBeenNthCalledWith(
      1,
      "https://mock.example.api/items?page=1&per_page=1&sort=-test&api_key="
    );
  });
  ...
  it("should call api with first sortOptions filter type from props (getInitFilters func)", async () => {
    ...
    expect(mock).toHaveBeenNthCalledWith(
      1,
      "https://mock.example.api/items?page=1&per_page=1&popular=true&api_key="
    );
  });
