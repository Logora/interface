...
const Providers = ({ children, currentUser = null, isLoggedIn = false, config = baseConfig }) => (
  <BrowserRouter>
...
export default {
  ...
  render: (args) => (
    <div style={{ width: args.width, height: args.height }}>
      <Providers isLoggedIn={args.isLoggedIn} currentUser={args.currentUser} config={args.config}>
        <NavbarModal />
      </Providers>
    </div>
  )
