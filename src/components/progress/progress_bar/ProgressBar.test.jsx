...
describe("ProgressBar", () => {
	...
	it("should render progressBar with title", () => {
		const progressBar = render(
			<IntlProvider locale="en">
				<ProgressBar progress={25} goal={100} title={"Title"}>
					My progress bar
				</ProgressBar>
			</IntlProvider>,
		);
	...
	it("should render progressBar with progress subtitle without unit", () => {
		const progressBar = render(
			<IntlProvider locale="en">
				<ProgressBar progress={25} goal={100} showProgressSubtitle={true} />
			</IntlProvider>,
		);
	...
	it("should render progressBar with percentage subtitle", () => {
		const progressBar = render(
			<IntlProvider locale="en">
				<ProgressBar progress={25} goal={100} showPercentageSubtitle={true} />
			</IntlProvider>,
		);
