...
export const ProposalBox = ({
	...
	const title = useTranslatedContent(
		proposal.title,
		proposal.language,
		"title",
		proposal.translation_entries,
	);
	...
	return (
		<HashScroll elementId={proposalId} onScroll={() => setFlash(true)}>
			<div
				className={cx(styles.proposalBoxContainer, { [styles.flash]: flash })}
				id={proposalId}
			>
				<ContentHeader
				...
				/>
				<div
					className={cx(styles.proposalBoxContent, {
						[styles.fixedHeight]: fixedContentHeight,
						[styles.withMinHeight]: !fitContent && !fixedContentHeight,
					})}
				>
					<div>
						<ReadMore
