...
export const SuggestionBanner = () => {
	...
	return (
		<div
			className={cx(styles.suggestionBannerContainer, {
				[styles.suggestionBannerContainerWrapped]: elementWidth < 768,
			})}
		>
			<div
				className={cx(styles.suggestionBannerContext, {
			...
			>
				...
				<Button
					...
					className={cx(styles.suggestionBannerButton, {
						[styles.isMobile]: isMobile,
					})}
			...
			<div
				className={cx(styles.suggestionBannerList, {
				...
				<VotePaginatedList
					...
					emptyListComponent={
						<UserContentSkeleton border enableAnimation={false} numberLines={3}>
							<Button
								data-tid={"action_add_suggestion"}
								to={routes.suggestionLocation.toUrl()}
							>
								{intl.formatMessage({
									id: "suggestion.suggestion_blank_box.add_suggestion",
