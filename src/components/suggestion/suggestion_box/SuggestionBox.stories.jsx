...
const debateShowLocation = new Location('espace-debat/group/:debateSlug', { debateSlug: '' });
...
const baseSuggestion = generateSuggestion(
  { is_published: false },
...
const publishedSuggestion = generateSuggestion(
  { is_published: true },
  { is_accepted: true, is_expired: false }
);
