...
export const Summary = ({ summaryId, tags = [], tagClassNames = [], title, subtitle, apiUrl = "https://nlp.logora.fr" }) => {
    const [summaries, setSummaries] = useState({});

    const fetchSummary = async (summaryId, tagId = '') => {
        try {
            const url = `${apiUrl}/analysis/argument-summary-${summaryId}${tagId ? `-${tagId}` : ''}`;
