...
export const DefaultSummaryBox = () => {
	...
	return <SummaryBox summaryItems={generateContent()} tag={"Yes"} />;
};
...
export const SummaryBoxWithoutTag = () => {
	...
	return <SummaryBox summaryItems={generateContent()} />;
};

export const SummaryBoxEmpty = () => {
	return <SummaryBox summaryItems={[]} emptySummaryText="No elements found" />;
};
