...
describe("UserBox", () => {
	it("renders component with correct data", () => {
		...
		const avatarImg = getByAltText(
			contributorUser.full_name + "'s profile picture",
		);
		...
		expect(
			getByText(contributorUser.messages_count + " arguments"),
		).toBeInTheDocument();
	...
	it("renders component correctly when user has no contributor role", () => {
		...
		const avatarImg = getByAltText(
			defaultUser.full_name + "'s profile picture",
		);
		expect(avatarImg).toBeInTheDocument();
		...
		expect(
			getByText(defaultUser.messages_count + " arguments"),
		).toBeInTheDocument();
