...
export const useDeleteContent = (
			...
			showModal(
				<ConfirmModal
					...
					question={
						deleteQuestion ||
						intl.formatMessage({
							id: "info.delete_content_question",
	...
	const confirmDelete = () => {
		...
		toast(
			deleteAlert ||
				intl.formatMessage({
					id: "info.delete_content_alert",
					defaultMessage: "Your contribution has been deleted",
				}),
			{ type: "success" },
		);
		if (softDelete) {
			api
				.update(contentType, content.id, { is_deleted: true })
				.then((response) => {
